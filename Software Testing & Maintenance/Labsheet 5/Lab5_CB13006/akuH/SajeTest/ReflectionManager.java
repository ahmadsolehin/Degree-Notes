...
public class ReflectionManager implements JTstConstant
{
   static int actualListLength = 0;
   ...
   public static void main (String args[])

    {
       ...
       if (fileExist(FAULT_DIRECTORY+className+".class"))
         {
