...
\fl{}\moduleLeftDash\cl{ {\MODULE} lab\_1\_CB13006}\moduleRightDash\cl{}
\fl{ {\EXTENDS} Naturals}
\fl{ {\VARIABLE} hr ,\, min}
\fl{}
 \fl{ HCini}\al{4}{1}{ \.{\defeq}}\al{4}{2}{ \.{\land}}\al{4}{3}{ hr \.{\in} (
 1 \.{\dotdot} 12 )}
\fl{ \.{\land}}\al{5}{1}{ min \.{\in} ( 1 \.{\dotdot} 60 )}
\fl{}
 \fl{ HCnxt}\al{7}{1}{ \.{\defeq} \.{\land} hr \.{'} \.{=} {\IF} hr \.{\neq}
 12 \.{\THEN} hr \.{+} 1 \.{\ELSE} 1}
 \fl{ \.{\land} min \.{'} \.{=} {\IF} min \.{\neq} 60 \.{\THEN} min \.{+} 1
 \.{\ELSE} 1}
\fl{}
 \fl{ HC \.{\defeq} HCini \.{\land} {\Box} [ HCnxt ]_{ {\langle} hr ,\, min
 {\rangle}}}
\fl{}
\fl{ HCnxt2 \.{\defeq} hr \.{'} \.{=} ( hr \.{\%} 12 ) \.{+} 1}
\fl{}
\fl{ HC2 \.{\defeq} HCini \.{\land} {\Box} [ HCnxt2 ]_{ hr}}
\fl{}
\fl{}\midbar\cl{}
\fl{ {\THEOREM} HC \.{\implies} {\Box} HCini}
\fl{}\bottombar\cl{}
\fl{}
\fl{}
\fl{}
